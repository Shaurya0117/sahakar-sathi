...
export default function LoginPage() {
  ...
  const demoAccounts = [
    ...
    { label: 'Worker', sub: 'Vishal Yadav', email: 'vishal.electrician@sahakarsathi.demo', password: 'Worker@1234', color: 'bg-emerald-50 hover:bg-emerald-100 text-emerald-800 border-emerald-200', icon: '🛠️' },
  ]
